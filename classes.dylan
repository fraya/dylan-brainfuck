...
define class <memory-data-instruction> (<memory-instruction>)
end;

define class <memory-pointer-instruction> (<memory-instruction>)
end;

define class <reset-to-zero> (<instruction>)
end;
